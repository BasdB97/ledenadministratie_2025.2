...
<div class="container mx-auto px-4 mt-8">
  <h2 class="text-2xl font-bold text-gray-800 mb-4">Familielid bewerken</h2>
  <div class="max-w-lg mx-auto bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="p-6 bg-gray-50 border border-gray-200">
      <form action="<?php echo URL_ROOT; ?>/familyMember/editFamilyMember/<?php echo $data['id']; ?>" method="post">
        <div class="mb-4">
